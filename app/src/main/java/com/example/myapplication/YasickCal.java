...
public class YasickCal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subActivity_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(YasickCal.this, Yasick.class);
                intent.putExtra("kcal", calculateMealTotal());
                intent.putExtra("menu", "엽기떡볶이");
    ...
    private ArrayList<Food> getListItemData(){
        ...
        listViewItems.add(new Food("엽기떡볶이",260));
