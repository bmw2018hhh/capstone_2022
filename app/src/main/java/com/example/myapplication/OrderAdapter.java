...
public class OrderAdapter extends ArrayAdapter<Food>{
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        ...
        if(listItemView == null){
            listItemView = LayoutInflater.from(getContext()).inflate(R.layout.item_my_meal,parent,false);
        }
        ...
        currentCost.setText((currentFood.getmAmount() * currentFood.getmQuantity())+"Kcal");
        quantityText.setText("x "+ currentFood.getmQuantity() + "인분");
